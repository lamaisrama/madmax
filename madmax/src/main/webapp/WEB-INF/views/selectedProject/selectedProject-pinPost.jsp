...
<div class="w-100 d-flex flex-column border p-3 mb-3 mt-3">
	...
	<c:forEach items="${projectBoardList}" var="pb">
    	...
    	<div class="w-100 d-flex flex-column align-items-center">
				...
				<c:forEach var="b" items="${bookmarkList}">
				  <c:if test="${pb.BOARDNO eq b.BOARDNO}">
	                ...
	                <div class="w-100 bg-white overflow-hidden mb-3">                
					    ...
					    <button type="button" class="btn btn-pinPost w-100 d-flex align-items-center" data-toggle="collapse" data-target="#pinPost-${pb.BOARDNO}" id="reportBoxBtn">
				            <strong>[글]</strong>
				            <p class="m-0 ml-2">${w.WRITINGTITLE}</p><!-- 글의 제목, 일정의 제목, 업무의 제목 셋중하나..ㅠㅠ -->
				        </button>
			        	                    
	                    <div  id="pinPost-${pb.BOARDNO}" class="collapse w-100"> 
	                        ...
	                        <div class="viewBundle w-100 bg-white rounded p-3">
	                            ...
	                            <div class="w-100 mt-4">      
	                                <div class="col-12 mb-3">
	                                    ...
	                                    <button class="btn stoolDarkBlue-btn-outline mr-2" type="button" data-toggle="collapse" data-target="#pin-collapseW${pb.BOARDNO}" aria-expanded="false" aria-controls="collapseExample"
	                                ...
	                                <div class="collapse" id="pin-collapseW${pb.BOARDNO}"> 
	                                    <!-- 공통) 태그 & 언급 -->
	 ...
	 <!-- ----------------------------------------------------------------------------------------------------- -->               	
					    ...
					    <button type="button" class="btn btn-pinPost w-100 d-flex align-items-center" data-toggle="collapse" data-target="#pinPost-${pb.BOARDNO}" id="reportBoxBtn">
				            <strong>[업무]</strong>
				            <p class="m-0 ml-2">${t.TASKTITLE}</p>
				        </button>
	                    ...
	                    <div class="pjViewBox w-100 p-3" value="p${pb.BOARDNO}">                              
	                        <div class="viewBundle w-100 bg-white rounded p-3">
	                            ...
	                            <div class="w-100 mt-4">      
	                                <div class="col-12 mb-3">
	                                	<!-- ※※※ collapse div의 변수를 반드시 다르게 주어야합니다!! -->
	                                    <button class="btn stoolDarkBlue-btn-outline mr-2" type="button" data-toggle="collapse" data-target="#pin_collapseW${pb.BOARDNO}" aria-expanded="false" aria-controls="collapseExample"
	                                            onclick="addBtniconChange(this);">
	                                       	 추가항목보기 <i class="fas fa-plus stoolDarkBlue-text ml-2" style="font-size:20px;"></i>
	                                    </button> 
	                                    <span class="stoolGrey">태그 / 언급 / 첨부파일을 보시려면 클릭하세요</span>
	                                ...
	                                <div class="collapse" id="pin_collapseW${pb.BOARDNO}"> 
	                                    <!-- 공통) 태그 & 언급 -->
										<c:set var="hashTagCk" value="N"/>
	                                    <div class="col-12 addTagListBox mb-2">
	                                        <div class="w-100 d-flex flex-column">
	                ...
	                <div id="postUpdateFormDiv${pb.BOARDNO}" class="d-none">
					    ...
					    <button type="button" class="btn btn-pinPost w-100 d-flex align-items-center" data-toggle="collapse" data-target="#pinPost-${pb.BOARDNO}" id="reportBoxBtn">
				            <strong>[일정]</strong>
				            <p class="m-0 ml-2">${s.SCHEDULETITLE}</p>
				        </button>
