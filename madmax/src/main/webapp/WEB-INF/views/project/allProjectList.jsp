...
<div class="col-sm-9">
	<table id="projectList" class="table">
		...
		<tbody id="allPjList">
			...
			<tr>
				<td>디자인팀</td>
				<td id="pjName">마케팅 켐페인 배너 디자인 프로젝트</td>
				<td>완료</td>
				<td>2019.03.02</td>
			...
			<tr>
				<td>IT팀</td>
				<td id="pjName">앱 2.0 업데이트 프로젝트</td>
				<td>진행중</td>
				<td>2020.01.05</td>
